                ...
                while (1) switch (_context4.prev = _context4.next) {
                  ...
                  case 8:
                    ...
                    return _index["default"].User.findAll({
                      ...
                      limit: +limit,
                      where: option.userId ? {
                        id: _defineProperty({}, _sequelize.Op.ne, option.userId)
                      } : {},
    ...
    var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(resolve, reject) {
      ...
      return _regeneratorRuntime().wrap(function _callee6$(_context6) {
        while (1) switch (_context6.prev = _context6.next) {
          ...
          case 8:
            _context6.next = 10;
            return _index["default"].Relationship.destroy({
              ...
              return _regeneratorRuntime().wrap(function _callee10$(_context10) {
                while (1) switch (_context10.prev = _context10.next) {
                  case 0:
                    _context10.prev = 0;
                    _context10.next = 3;
                    return _index["default"].Relationship.findOne({
                      where: {
    ...
    var _ref12 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee12(resolve, reject) {
      ...
      return _regeneratorRuntime().wrap(function _callee12$(_context12) {
        while (1) switch (_context12.prev = _context12.next) {
          ...
          case 12:
            _context12.next = 14;
            return _index["default"].Relationship.create({
              performerId: data.performerId,
              receiverId: data.receiverId,
              action: 'follow'
            });
              ...
              return _regeneratorRuntime().wrap(function _callee13$(_context13) {
                while (1) switch (_context13.prev = _context13.next) {
                  case 0:
                    _context13.prev = 0;
                    _context13.next = 3;
                    return _index["default"].Relationship.findAll();
                  case 3:
