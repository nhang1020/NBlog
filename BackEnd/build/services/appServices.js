        ...
        while (1) switch (_context2.prev = _context2.next) {
          ...
          case 8:
            ...
            if (user) {
              ...
              checkPassword = _bcryptjs["default"].compareSync(password, getPassword);
              if (checkPassword) {
                userData.errCode = 0;
                userData.message = "OK";
...
var searchDataService = function searchDataService(searchText) {
  return new Promise( /*#__PURE__*/function () {
    var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(resolve, reject) {
      var keyword, resultArray, users, posts, idsArray, images;
      return _regeneratorRuntime().wrap(function _callee6$(_context6) {
        while (1) switch (_context6.prev = _context6.next) {
          case 0:
            ...
            // });
            _context6.next = 5;
            return _index["default"].sequelize.query("SELECT id, firstName, lastName, avatar, role FROM Users WHERE firstName LIKE '%".concat(keyword, "%' OR lastName LIKE '%").concat(keyword, "%'"), {
              nest: true
            });
          case 5:
            ...
            return _index["default"].Post.findAll({
              ...
              where: _defineProperty({}, _sequelize.Op.or, [{
                contents: _defineProperty({}, _sequelize.Op.like, "%".concat(keyword, "%"))
              }, {
                '$userData.firstName$': _defineProperty({}, _sequelize.Op.like, "%".concat(keyword, "%"))
              }, {
                '$userData.lastName$': _defineProperty({}, _sequelize.Op.like, "%".concat(keyword, "%"))
              }]),
              raw: true,
              nest: true
            });
          case 8:
            ...
            _context6.next = 13;
            return _index["default"].sequelize.query("SELECT * from PostFiles WHERE postId in (".concat(idsArray, ")"), {
              nest: true
            });
          case 13:
