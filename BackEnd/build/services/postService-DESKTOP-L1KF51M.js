...
var getPostsService = function getPostsService(data) {
  return new Promise( /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(resolve, reject) {
      var posts, listPostId, images, likes;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            return db.Post.findAll({
              ...
              where: data.userId ? {
                ...
                privacy: _defineProperty({}, Op.ne, 'P2')
              },
              include: [
          ...
          case 3:
            posts = _context.sent;
            listPostId = posts.map(function (item) {
              return item.id;
            });
            if (data.userId) {
              _context.next = 11;
            ...
            _context.next = 8;
            return db.sequelize.query("SELECT PostFiles.*, Users.id as userId FROM PostFiles JOIN Posts ON PostFiles.postId = Posts.id JOIN Users ON Users.id = Posts.userId WHERE PostFiles.postId IN (SELECT Posts.id FROM Posts WHERE Users.id = Posts.userId) ".concat(listPostId.length ? "AND PostFiles.postId IN (".concat(listPostId, ")") : ''));
          case 8:
          ...
          case 11:
            _context.next = 13;
            return db.sequelize.query("SELECT PostFiles.*, Users.id as userId FROM PostFiles JOIN Posts ON PostFiles.postId = Posts.id JOIN Users ON Users.id = Posts.userId WHERE PostFiles.postId IN (SELECT Posts.id FROM Posts WHERE Users.id = Posts.userId AND Posts.userId = ".concat(data.userId, ") "));
          case 13:
            _context.t0 = _context.sent;
          case 14:
            images = _context.t0;
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          ...
          case 6:
            ...
            _context2.next = 11;
            return db.PostFile.bulkCreate(list);
          case 11:
            _context2.next = 13;
            return db.PostFile.findAll();
          case 13:
